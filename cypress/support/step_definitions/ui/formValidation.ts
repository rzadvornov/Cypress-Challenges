...
Given(
  "the user enters an invalid phone number {string}",
...
Given(
  "the user should see a message confirming that the Contact Name is valid",
  () => {
...
Then(
  "the user should see an error message indicating invalid phone format",
  () => {
...
Then(
  "the user should see an error message indicating invalid date range",
  () => {
